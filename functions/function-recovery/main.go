// Package main implements a Crossplane Operation Function.
package main
...
func (c *CLI) Run() error {
	...
	return function.Serve(&Function{log: log}, function.Listen(c.Network, c.Address), function.MTLSCertificates(c.TLSCertsDir), function.Insecure(c.Insecure), function.MaxRecvMessageSize(c.MaxRecvMessageSize*1024*1024))
}
